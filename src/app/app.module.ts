/**
 * Created by Vision-Dream on 17/05/2019.
 */
...
// Modules - Browser and Http Client
import { BrowserModule } from '@angular/platform-browser';
import { HttpClientModule } from '@angular/common/http';
import { BrowserAnimationsModule } from '@angular/platform-browser/animations';

// Modules - Date Picker, NgModule, Forms, Routing, Date Pipe and Material (table and auto complete)
//import { NgxBootstrapDateTimePickerModule } from 'ngx-bootstrap-datetime-picker/ngx-bootstrap-datetime-picker';
...
// Material (sort, paginator, form field, input and snack bar) and Components
